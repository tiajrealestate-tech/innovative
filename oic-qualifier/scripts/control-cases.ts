...
const cases: Case[] = [
  ...
  { id: 7, summary: "Single, home with equity", state: baseState({ household: { totalIrsDebt: 80000 }, income: { wagesBenefits: 3000 }, expenses: { housingUtilities: 1300 }, assets: { homeMarket: 250000, homeLoan: 150000 } }) },
  { id: 8, summary: "Single, underwater home + rental", state: baseState({ household: { totalIrsDebt: 70000 }, income: { wagesBenefits: 3000, netRental: 400 }, expenses: { housingUtilities: 1300 }, assets: { homeMarket: 150000, homeLoan: 190000, otherRealEstateMarket: 90000, otherRealEstateLoan: 40000 } }) },
  { id: 9, summary: "Single, one owned car (exclusion)", state: baseState({ income: { wagesBenefits: 3200 }, expenses: { housingUtilities: 1200, vehicleCount: 1, vehicleLoansLeases: 450, vehicleOperating: 250 }, assets: { vehicle1Market: 15000, vehicle1Loan: 4000 } }) },
  { id: 10, summary: "Single, two owned cars", state: baseState({ income: { wagesBenefits: 3200 }, expenses: { housingUtilities: 1200, vehicleCount: 2, vehicleLoansLeases: 450, vehicleOperating: 400 }, assets: { vehicle1Market: 15000, vehicle2Market: 10000 } }) },
  { id: 11, summary: "Joint, two owned cars", state: baseState({ household: { jointEstimate: true, members: 2, under65: 2 }, income: { wagesBenefits: 5000 }, expenses: { housingUtilities: 1400, vehicleCount: 2, vehicleLoansLeases: 450, vehicleOperating: 400 }, assets: { vehicle1Market: 15000, vehicle2Market: 10000 } }) },
  { id: 12, summary: "Single, leased car + transit", state: baseState({ income: { wagesBenefits: 3500 }, expenses: { housingUtilities: 1200, vehicleCount: 1, vehicleLoansLeases: 400, vehicleOperating: 200, publicTransportation: 150 }, assets: { vehicle1Market: 0 } }) },
  { id: 13, summary: "Single, other assets (boat/RV)", state: baseState({ income: { wagesBenefits: 2500 }, expenses: { housingUtilities: 1200 }, assets: { otherAssetsMarket: 30000, otherAssetsLoan: 2000 } }) },
  { id: 14, summary: "Single, investments + crypto", state: baseState({ income: { wagesBenefits: 2500, interestDividendsRoyalties: 100 }, expenses: { housingUtilities: 1200 }, assets: { investmentsNet: 15000 } }) },
  { id: 15, summary: "Single, life insurance cash value", state: baseState({ income: { wagesBenefits: 2500 }, expenses: { housingUtilities: 1200 }, assets: { lifeInsuranceNet: 7000 } }) },
  ...
  { id: 20, summary: "Single, miscellaneous equity only", state: baseState({ income: { wagesBenefits: 2000 }, expenses: { housingUtilities: 1100 }, assets: { miscellaneous: 7000 } }) },
];
