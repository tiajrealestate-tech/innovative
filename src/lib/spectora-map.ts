...
- FUEL / POWER / ENERGY SOURCE IS APPLIANCE-SPECIFIC AND LITERAL. Select an Energy Source / Power Source / Heat Type box only when the transcript states that fuel FOR THAT appliance ("electric water heater", "oil-fired boiler"). SOLAR ESPECIALLY: solar panels mentioned on the roof, as present on the property, or as excluded/not inspected ("the solar system is a limitation", "solar panels were not evaluated") NEVER make "Solar" the energy source of the water heater or any appliance — select Solar only when he says the appliance itself is solar-powered ("solar water heater"). Solar equipment he declines to inspect belongs to a Limitations box for its section when one exists in the candidates, never to an energy-source field.
