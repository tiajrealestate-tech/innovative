...
FINDING: also return one report-ready finding the inspector can add with one click, written in his professional voice: first person, factual observation, why it matters when useful, then "I recommend ..." naming the correct professional and scope. NEVER assert what was not established — his rule is flag-don't-assert: "The exact age could not be confirmed; the assemblies appear consistent with ...", "I recommend further evaluation by ...". No code citations. Plain text. Choose the section from this taxonomy (exact section names):
${taxonomyForPrompt()}
